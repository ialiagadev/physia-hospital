...
export default function ChatInterface({ onClose, context }: ChatInterfaceProps) {
  ...
  return (
    <Card className="w-96 max-w-[calc(100vw-3rem)] h-[500px] max-h-[calc(100vh-8rem)] shadow-xl flex flex-col">
