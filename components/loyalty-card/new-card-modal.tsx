...
export function NewCardModal({ open, onOpenChange, clientId, organizationId, onCardCreated }: NewCardModalProps) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            <div className="space-y-4">
              ...
              <PhysiaCard
                card={previewCard}
                customerName={client?.name || "Nombre del Cliente"}
                customerID={client?.tax_id || "ID-CLIENTE"}
                readOnly={true}
              />
            </div>
          </div>
