...
/**
 * Sube una imagen al bucket de Supabase Storage (server-side)
...
/**
 * Sube una imagen en formato base64 al bucket de Supabase Storage (server-side)
...
/**
 * Elimina una imagen del bucket de Supabase Storage (server-side)
